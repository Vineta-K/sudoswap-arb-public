...
//ty @0xAlcibiades for writing pretty much all of this contract and making it public :)
    ...
    object "MulticallRuntime" {
        ...
        */
        code {
            ...
            case 0x150b7a02 /* function 'onERC721Received(address,address,uint256,bytes)' -> allows this contract to recieve SafeTransferFrom ERC721 stuff */
            {
                let r := 0x150b7a0200000000000000000000000000000000000000000000000000000000
            ...
            */
            ...
            function owner() -> o {
                ...
                o := 0x000000000000000000000000000000000000dEaD
            }
